...
func (atq *AccessTokenQuery) QueryRefreshToken() *RefreshTokenQuery {
	query := (&RefreshTokenClient{config: atq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := atq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (atq *AccessTokenQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (atq *AccessTokenQuery) FirstIDX(ctx context.Context) uint {
...
func (atq *AccessTokenQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (atq *AccessTokenQuery) OnlyIDX(ctx context.Context) uint {
...
func (atq *AccessTokenQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (atq *AccessTokenQuery) IDsX(ctx context.Context) []uint {
	ids, err := atq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (atq *AccessTokenQuery) Clone() *AccessTokenQuery {
	...
	return &AccessTokenQuery{
		...
		withRefreshToken: atq.withRefreshToken.Clone(),
...
func (atq *AccessTokenQuery) WithRefreshToken(opts ...func(*RefreshTokenQuery)) *AccessTokenQuery {
	query := (&RefreshTokenClient{config: atq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	atq.withRefreshToken = query
	return atq
}
...
func (atq *AccessTokenQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*AccessToken, error) {
	...
	if query := atq.withRefreshToken; query != nil {
		if err := atq.loadRefreshToken(ctx, query, nodes, nil,
			func(n *AccessToken, e *RefreshToken) { n.Edges.RefreshToken = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (atq *AccessTokenQuery) loadRefreshToken(ctx context.Context, query *RefreshTokenQuery, nodes []*AccessToken, init func(*AccessToken), assign func(*AccessToken, *RefreshToken)) error {
	...
	query.Where(refreshtoken.IDIn(ids...))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	}
...
func (atq *AccessTokenQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(accesstoken.Table, accesstoken.Columns, sqlgraph.NewFieldSpec(accesstoken.FieldID, field.TypeUint))
	_spec.From = atq.sql
