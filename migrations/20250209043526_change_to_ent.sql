...
--------------------------------------------------------------------------------
-- STEP 4: Recreate new PK constraints or unique indexes as needed
--------------------------------------------------------------------------------

-- 4.1: users -> new PK name = users_pkey, plus unique index on email
alter table only public.users
add constraint users_pkey primary key (id);

create unique index users_email_key on public.users using btree (email);

-- 4.2: videos -> new PK name = videos_pkey
...
--------------------------------------------------------------------------------
-- STEP 5: Re-add foreign key constraints with new constraint names
--------------------------------------------------------------------------------
...
-------------------------------------------------------------------------
-- STEP 6: Recreate indexes that are in the new schema but not the old
-------------------------------------------------------------------------
